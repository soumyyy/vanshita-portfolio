  ...
  return (
    <nav
      className={cn(
        ...
        isScrolled ? "bg-background/80 backdrop-blur-md border-b border-border py-3" : "bg-transparent py-6",
      )}
    >
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        <Link href="/" className="font-cursive text-3xl md:text-4xl leading-none text-primary">
          Vanshita Kalra
        </Link>
